...
# Query params
HotelIdSchema = schemas.AnyTypeSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'hotelId': typing.Union[HotelIdSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
    }
)
...
request_query_hotel_id = api_client.QueryParameter(
    name="hotelId",
    style=api_client.ParameterStyle.FORM,
    schema=HotelIdSchema,
    required=True,
    explode=True,
)
...
class DataHotelGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_hotel_details_call(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_hotel_details_call(
        ...
        return self._get_hotel_details_oapg(
    ...
    def get_hotel_details(
        ...
        try:
            ...
            api_response = self.get_hotel_details_call(
                query_params=query_params
            )
            return api_response.body
        except exceptions.ApiException as e:
            return ("Exception when calling StaticDataApi->get_hotel_details: %s\n" % e)
