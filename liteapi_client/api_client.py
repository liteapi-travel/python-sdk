...
from liteapi_client import rest
from liteapi_client.configuration import Configuration
from liteapi_client.exceptions import ApiTypeError, ApiValueError
from liteapi_client.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class LiteApiResponse(JSONDetector):
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'liteAPI-Generator/1.0.0/python'
    ...
    def call_api(
        ...
        :param stream: if True, the urllib3.HTTPResponse object will
                                 ...
                                 data. Also when True, if the liteAPI spec describes a file download,
