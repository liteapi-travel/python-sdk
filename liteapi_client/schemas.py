...
from liteapi_client.exceptions import (
    ApiTypeError,
    ApiValueError,
)
from liteapi_client.configuration import (
    Configuration,
)
...
class ValidationMetadata(frozendict.frozendict):
    """
    A class storing metadata that is needed to validate liteApi Schema payloads
    """
    def __new__(
        cls,
...
class Schema:
    """
    the base class of all swagger/liteapi schemas/models
    """
    ...
    def _get_new_instance_without_conversion_oapg(
        ...
        """
        str = liteapi str, date, and datetime
        decimal.Decimal = liteapi int and float
        FileIO = liteapi binary type and the user inputs a file
        bytes = liteapi binary type and the user inputs bytes
        """
        return super(Schema, cls).__new__(cls, arg)

    @classmethod
    def from_liteapi_data_oapg(
        cls,
        arg: typing.Union[
            str,
            date,
...
class ValidatorBase:
    ...
    def _is_json_validation_enabled_oapg(schema_keyword, configuration=None):
        ...
        Note: the suffix _oapg stands for liteapi python (experimental) generator and
...
class ComposedSchema(
    ...
    @classmethod
    def from_liteapi_data_oapg(cls, *args: typing.Any, _configuration: typing.Optional[Configuration] = None, **kwargs):
        if not args:
            if not kwargs:
                raise ApiTypeError('{} is missing required input data in args or kwargs'.format(cls.__name__))
            args = (kwargs, )
        return super().from_liteapi_data_oapg(args[0], _configuration=_configuration)
...
class ListSchema(
    ...
    @classmethod
    def from_liteapi_data_oapg(cls, arg: typing.List[typing.Any], _configuration: typing.Optional[Configuration] = None):
        return super().from_liteapi_data_oapg(arg, _configuration=_configuration)
...
class NoneSchema(
    ...
    @classmethod
    def from_liteapi_data_oapg(cls, arg: None, _configuration: typing.Optional[Configuration] = None):
        return super().from_liteapi_data_oapg(arg, _configuration=_configuration)
...
class NumberSchema(
    ...
    @classmethod
    def from_liteapi_data_oapg(cls, arg: typing.Union[int, float], _configuration: typing.Optional[Configuration] = None):
        return super().from_liteapi_data_oapg(arg, _configuration=_configuration)
...
class IntSchema(IntBase, NumberSchema):
    ...
    @classmethod
    def from_liteapi_data_oapg(cls, arg: int, _configuration: typing.Optional[Configuration] = None):
        return super().from_liteapi_data_oapg(arg, _configuration=_configuration)
...
class Float32Schema(
    ...
    @classmethod
    def from_liteapi_data_oapg(cls, arg: float, _configuration: typing.Optional[Configuration] = None):
        return super().from_liteapi_data_oapg(arg, _configuration=_configuration)
...
class StrSchema(
    ...
    @classmethod
    def from_liteapi_data_oapg(cls, arg: str, _configuration: typing.Optional[Configuration] = None) -> 'StrSchema':
        return super().from_liteapi_data_oapg(arg, _configuration=_configuration)
...
class BoolSchema(
    ...
    @classmethod
    def from_liteapi_data_oapg(cls, arg: bool, _configuration: typing.Optional[Configuration] = None):
        return super().from_liteapi_data_oapg(arg, _configuration=_configuration)
...
class DictSchema(
    ...
    @classmethod
    def from_liteapi_data_oapg(cls, arg: typing.Dict[str, typing.Any], _configuration: typing.Optional[Configuration] = None):
        return super().from_liteapi_data_oapg(arg, _configuration=_configuration)
