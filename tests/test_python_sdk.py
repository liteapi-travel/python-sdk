import unittest
from python_sdk.client import LiteApiClient  # Corrected the import to use LiteApiClient

class TestPythonSDK(unittest.TestCase):

    def setUp(self):
        self.client = LiteApiClient(api_key="your_api_key")  # Replace with the actual API key

    def test_get_hotels(self):
        response = self.client.get("/data/hotels", params={})
